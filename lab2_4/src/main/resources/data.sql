insert into "literature" ("literature_source") values ('литература 1');
insert into "literature" ("literature_source") values ('литература 2');
insert into "literature" ("literature_source") values ('литература 3');
insert into "literature" ("literature_source") values ('литература 4');
insert into "literature" ("literature_source") values ('литература 5');

-- insert into "school" ("school_number", "school_name") values (2, 'Факультет 1');
